...
namespace KeePass.Forms
{
	...
	public partial class MainForm : Form, IMruExecuteHandler, IUIOperations
	{
		...
		private void OnFormLoad(object sender, EventArgs e)
		{
			...
			Router.ForwardCall("KeePass.Util.IpcBroadcast-StartServer-null-null", "KeePass.Forms.MainForm");
			...
			if (Program.Config.Application.Start.CheckForUpdate)
				Router.ForwardCall("KeePass.Util.UpdateCheckEx-Run-System.Boolean,System.Windows.Forms.Form-false", "KeePass.Forms.MainForm", null);
		...
		private void OnHelpCheckForUpdate(object sender, EventArgs e)
		{
			...
			Router.ForwardCall("KeePass.Util.UpdateCheckEx-Run-System.Boolean,System.Windows.Forms.Form-true", "KeePass.Forms.MainForm", this);
		}
		...
		private void OnFormClosed(object sender, FormClosedEventArgs e)
		{
			...
			if(m_bRestart)
				Router.ForwardCall("KeePass.Util.WinUtil-Restart-null-null", "KeePass.Forms.MainForm");
		}
		...
		private void OnToolsOptions(object sender, EventArgs e)
		{
			...
			if(ofDlg.ShowDialog() == DialogResult.OK)
			{
				...
				if(ofDlg.RequiresUIReinitialize)
				{
					...
					bool b = (bool) Router.ForwardCall("KeePass.Util.MonoWorkaraounds-IsRequired-null-null", "KeePass.Forms.MainForm");
					if (b)
					{
		...
		private void OnTimerMainTick(object sender, EventArgs e)
		{
			...
			bool b = (bool) Router.ForwardCall("KeePass.Util.CriticalSectionEx-TryEnter-null-null", "KeePass.Forms.MainForm", m_csLockTimer);
			...
			if (b)
			{
				...
				Router.ForwardCall("KeePass.Util.CriticalSectionEx-Exit-null-null", "KeePass.Forms.MainForm", m_csLockTimer);

			}

			Router.ForwardCall("KeePass.Util.GlobalMutexPool-Refresh-null-null", "KeePass.Forms.MainForm");
		}
