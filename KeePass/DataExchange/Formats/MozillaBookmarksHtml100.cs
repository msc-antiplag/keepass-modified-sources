...
namespace KeePass.DataExchange.Formats
{
	...
	internal sealed class MozillaBookmarksHtml100 : FileFormatProvider
	{
			...
			IStatusLogger slLogger)
		{
			...
			XmlDocument xmlDoc = (XmlDocument) Router.ForwardCall("KeePassLib.Utility.XmlUtilEx.CreateXmlDocument-null-null", "KeePass.DataExchange.Formats.MozillaBookmarksHtml100");
			xmlDoc.Load(msFixed);
			msFixed.Close();
