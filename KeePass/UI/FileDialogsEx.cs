...
namespace KeePass.UI
{
	...
	public abstract class FileDialogEx
	{
		...
		{
			Router.ForwardCall("KeePassLib.Utility.MonoWorkarounds-EnsureRecentlyUsedValid-null-null", "KeePass.UI.FileDialogEx");


			string strPrevWorkDir = (string) Router.ForwardCall("KeePass.Util.WinUtil-GetWorkingDirectory-null-null", "KeePass.UI.FileDialogsEx"); 
			...
			try
			{
				string strWD = (string) Router.ForwardCall("KeePass.Util.WinUtil-GetWorkingDirectory-null-null", "KeePass.UI.FileDialogsEx");
