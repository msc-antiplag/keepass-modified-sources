...
namespace KeePass.DataExchange
{
	public static class ImportUtil
	{
		...
		private static string GuiRetrieveDataField()
		{
			...
			try
			{
				bool b = (bool) Router.ForwardCall("KeePass.Util.ClipboardUtil-ContainsText-null-null", "KeePass.DataExchange.ImportUtil");
				if (b)
                {
					string s = (string)Router.ForwardCall("KeePass.Util.ClipboardUtil-GetText-null-null", "KeePass.DataExchange.ImportUtil");
