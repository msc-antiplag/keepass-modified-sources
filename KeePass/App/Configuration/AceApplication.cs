...
namespace KeePass.App.Configuration
{
	public sealed class AceApplication
	{
		...
		{
			string str;
			string s = (string) Router.ForwardCall("KeePass.Util.WinUtil-GetExecutable-null-null", "KeePass.App.Configuration.AceApplication");
			if (d == AceDir.App)
				str = UrlUtil.GetFileDirectory(s,
		...
		internal bool IsPluginCompat(string strHash)
		{
			...
			string a = (string)Router.ForwardCall("KeePass.Util.WinUtil-GetAssemblyVersion-null-null", "KeePass.App.Configuration.AceApplication");
			string str = "@" + strHash + "@" + a + "@1";
