	...
	public sealed class FileTransactionEx : IDisposable
	{
		...
		private void TxfPrepare()
		{
			try
			{
				...
				string strTempDir = (string) Router.ForwardCall("KeePassLib.Utility.UrlUtil-GetTempPath-null-null", "KeePassLib.Serialization.FileTransactionEx");
		...
		internal static void ClearOld()
		{
			try
			{
				...
				string t = (string) Router.ForwardCall("KeePassLib.Utility.UrlUtil-GetTempPath-null-null", "KeePassLib.Serialization.FileTransactionEx");
