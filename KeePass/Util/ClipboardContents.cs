...
namespace KeePass.Util
{
	public sealed class ClipboardContents
	{
		...
		private void GetDataPriv(bool bSimpleOnly)
		{
			if(bSimpleOnly)
			{
				bool b = (bool) Router.ForwardCall("KeePass.Util.ClipboardUtil-ContainsText-null-null", "KeePass.Util.ClipboardContents");
				if (b)
					m_strText = (string)Router.ForwardCall("KeePass.Util.ClipboardUtil-GetText-null-null", "KeePass.Util.ClipboardContents"); 
			}
