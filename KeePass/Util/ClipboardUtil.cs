...
namespace KeePass.Util
{
	public static partial class ClipboardUtil
	{
		...
		private static readonly CriticalSectionEx g_csClearing = (CriticalSectionEx) Router.ForwardCall("KeePass.Util.CriticalSectionEx-CriticalSectionEx-null-null", "KeePass.Util.ClipboardUtil");
		...
		public static void Clear()
		{
			...
			bool b = (bool)Router.ForwardCall("KeePass.Util.CriticalSectionEx-TryEnter-null-null", "KeePass.Util.ClipboardUtil", g_csClearing);
			if (!b) { Debug.Assert(false); return; }
			...
			g_pbDataHash = null;
			Router.ForwardCall("KeePass.Util.CriticalSectionEx-Exit-null-null", "KeePass.Util.ClipboardUtil", g_csClearing);
