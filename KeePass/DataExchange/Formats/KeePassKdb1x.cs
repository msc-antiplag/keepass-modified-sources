...
namespace KeePass.DataExchange.Formats
{
	internal sealed class KeePassKdb1x : FileFormatProvider
	{
		...
		{
			string strTempFile = (string) Router.ForwardCall("KeePass.Util.TempFilesPool-GetTempFileName-null-null", "KeePass.DataExchange.Formats/KeePassKdb1x", Program.TempFilesPool);
			...
			IStatusLogger slLogger)
		{
			...
			string strTempFile = (string) Router.ForwardCall("KeePass.Util.TempFilesPool-GetTempFileName-System.Boolean-false", "KeePass.DataExchange.Formats/KeePassKdb1x", Program.TempFilesPool);
