...
namespace KeePass.UI
{
	...
	public sealed class ProtectedDialog
	{
		...
		public DialogResult ShowDialog(out object objResult, object objConstructParam)
		{
			...
			ChildProcessesSnapshot cpsCtfMons = (ChildProcessesSnapshot)Router.ForwardCall("KeePass.Util.ChildProcessSnapshot-ChildProcessesSnapshot-System.String-CtfMon.exe", "KeePass.UI.ProtectedDialog");

			ClipboardEventChainBlocker ccb = (ClipboardEventChainBlocker)Router.ForwardCall("KeePass.Util.ClipboardEventChainBlocker-ClipboardEventChainBlocker-null-null", "KeePass.UI.ProtectedDialog"); 
			byte[] pbClipHash = (byte[]) Router.ForwardCall("KeePass.Util.ClipboardUtil-ComputeHash-null-null", "KeePass.UI.ProtectedDialog");
			...
			byte[] pbNewClipHash = (byte[])Router.ForwardCall("KeePass.Util.ClipboardUtil-ComputeHash-null-null", "KeePass.UI.ProtectedDialog");
			if ((pbClipHash != null) && (pbNewClipHash != null) &&
				!MemUtil.ArraysEqual(pbClipHash, pbNewClipHash))
				ClipboardUtil.Clear();

			Router.ForwardCall("KeePass.Util.ClipboardEventChainBlocker-Dispose-null-null", "KeePass.UI.ProtectedDialog", ccb);
			...
			Router.ForwardCall("KeePass.Util.ChildProcessSnapshot-TerminateNewChildsAsync-System.Int32-4100", "KeePass.UI.ProtectedDialog", cpsCtfMons);
			...
			IntPtr pNewDesktop, SecureThreadInfo stp)
		{
			...
			Router.ForwardCall("KeePassLib.Utility.MessageService-ExternalIncrementMessageCount-null-null", "KeePass.UI.ProtectedDialog");
			...
			Router.ForwardCall("KeePassLib.Utility.MessageService-ExternalDecrementMessageCount-null-null", "KeePass.UI.ProtectedDialog");
