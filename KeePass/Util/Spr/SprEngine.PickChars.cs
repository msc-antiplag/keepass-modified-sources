	...
	public static partial class SprEngine
	{
			...
			uint uRecursionLevel)
		{
			...
			if(ps != null)
			{
				...
				SprContext c = (SprContext) Router.ForwardCall("KeePass.Util.Spr.SprContext-WithoutContentTransformations-null-null", "KeePass.Util.Spr.SprEngine.PickChars", ctx);
