	...
	public partial class AboutForm : Form, IGwmWindow
	{
		...
		private void OnFormLoad(object sender, EventArgs e)
		{
			...
			if(Program.IsDevelopmentSnapshot())
			{
				...
				try
				{
					string strExe = (string)Router.ForwardCall("KeePass.Util.WinUtil-GetExecutable-null-null", "KeePass.Forms.AboutForm"); 
		...
		private void GetAppComponents(string strMainVersion)
		{
			...
			string strPath = (string) Router.ForwardCall("KeePass.Util.WinUtil-GetExecutable-null-null", "KeePass.Forms.AboutForm");
