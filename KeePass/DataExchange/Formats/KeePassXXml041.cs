...
namespace KeePass.DataExchange.Formats
{
	...
	internal sealed class KeePassXXml041 : FileFormatProvider
	{
		...
		{
			XmlDocument xmlDoc = (XmlDocument) Router.ForwardCall("KeePassLib.Utility.XmlUtilEx.CreateXmlDocument-null-null", "KeePass.DataExchange.Formats.KeePassXXml041");
			xmlDoc.Load(sInput);
