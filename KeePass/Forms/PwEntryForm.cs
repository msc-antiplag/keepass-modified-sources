...
namespace KeePass.Forms
{
	...
	public partial class PwEntryForm : Form
	{
		...
		private bool SaveEntry(PwEntry peTarget, bool bValidate)
		{
			...
			{
				CancellableOperationEventArgs eaCancel = (CancellableOperationEventArgs)Router.ForwardCall("KeePass.Util.CancellableOperationEventArgs-CancellableOperationEventArgs-null-null", "KeePass.Forms.PwEntryForm");
		...
		private void OnProfilesDynamicMenuClick(object sender, DynamicMenuEventArgs e)
		{
			...
			{
				List<PwProfile> p = (List<PwProfile>)Router.ForwardCall("KeePass.Util.PwGeneratorUtil-GetAllProfiles-System.Boolean-false", "KeePass.Util.PwEntryForm");
				foreach(PwProfile pwgo in p)
				{
		...
		private void OnPwGenClick(object sender, EventArgs e)
		{
			...
			List<PwProfile> p = (List<PwProfile>) Router.ForwardCall("KeePass.Util.PwGeneratorUtil-GetAllProfiles-System.Boolean-true", "KeePass.Util.PwEntryForm");
			foreach (PwProfile pwgo in p)
			{
		...
		private void OpenSelBin(BinaryDataOpenOptions optBase)
		{
			...
			BinaryDataOpenOptions x = (BinaryDataOpenOptions) Router.ForwardCall("KeePass.Util.BinaryDataOpenOptions-CloneDeep-null-null", "KeePass.Forms.PwEntryForm", optBase);
			BinaryDataOpenOptions opt = ((optBase != null) ? x : new BinaryDataOpenOptions());
