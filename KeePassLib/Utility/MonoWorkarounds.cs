...
namespace KeePassLib.Utility
{
	public static class MonoWorkarounds
	{
		...
		internal static bool ExchangeFormShownRaised(bool bNewValue, Form f)
		{
		...
		internal static void EnsureRecentlyUsedValid()
		{
			...
			try
			{
				...
				{
					XmlDocument xd = (XmlDocument)Router.ForwardCall("KeePassLib.Utility.XmlUtilEx-CreateXmlDocument-null-null", "KeePassLib.Utility.MonoWorkarounds");
					try
					{
