...
namespace KeePass.UI
{
	...
	{
		private CriticalSectionEx m_csSizeAuto = (CriticalSectionEx) Router.ForwardCall("KeePass.Util.CriticalSectionEx-CriticalSectionEx-null-null", "KeePass.UI.CustomToolStripEx");
		...
		{
			bool b = (bool)Router.ForwardCall("KeePass.Util.CriticalSectionEx-TryEnter-null-null", "KeePass.UI.CustomToolStripEx", m_csSizeAuto);
			if (b)
			{
				try
				{
					...
					Router.ForwardCall("KeePass.Util.CriticalSectionEx-Exit-null-null", "KeePass.UI.CustomToolStripEx", m_csSizeAuto);
				}
			}
