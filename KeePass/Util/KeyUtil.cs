...
namespace KeePass.Util
{
	public static class KeyUtil
	{
		...
		private static void ClearKeyOptions(CommandLineArgs args, bool bOnlyIfOptionEnabled)
		{
			...
			Router.ForwardCall("KeePass.Util.CommandLineArgs-Remove-System.String-pw", "KeePass.Util.KeyUtil", args);
			Router.ForwardCall("KeePass.Util.CommandLineArgs-Remove-System.String-pw_enc", "KeePass.Util.KeyUtil", args);
			Router.ForwardCall("KeePass.Util.CommandLineArgs-Remove-System.String-pw_stdin", "KeePass.Util.KeyUtil", args);
			Router.ForwardCall("KeePass.Util.CommandLineArgs-Remove-System.String-keyfile", "KeePass.Util.KeyUtil", args);
			Router.ForwardCall("KeePass.Util.CommandLineArgs-Remove-System.String-preselect", "KeePass.Util.KeyUtil", args);
			Router.ForwardCall("KeePass.Util.CommandLineArgs-Remove-System.String-useraccount", "KeePass.Util.KeyUtil", args);
