...
namespace KeePass
{
	public static class Program
	{
		...
		public static void Main(string[] args)
		{
			...
			//Router.init();
			Console.WriteLine("[*] Router init() terminated!");
			

			Router.testWithStrings(typeof(UrlUtil), "GetTempPath-null-null");
			Console.WriteLine("\n[*] Terminating ...");
			return;
        ...
        {
			string strFileOut = UrlUtil.EnsureTerminatingSeparator(((string)Router.testWithStrings(typeof(UrlUtil), "GetTempPath-null-null")), false) + "KeePass_UrlOverride.tmp";

			Router.testWithStrings(typeof(UrlUtil), "GetTempPath-null-null");

			PwUuid pwUuid = new PwUuid(false);
