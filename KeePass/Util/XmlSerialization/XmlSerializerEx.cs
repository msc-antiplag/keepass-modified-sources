...
namespace KeePass.Util.XmlSerialization
{
	public sealed partial class XmlSerializerEx : IXmlSerializerEx
	{
		...
		internal static void GenerateSerializers(CommandLineArgs cl)
		{
			...
			{
				string s = (string) Router.ForwardCall("KeePass.Util.WinUtil-GetExecutable-null-null", "KeePass.Util.XmlSerialization.XmlSerializerEx");
				strFile = UrlUtil.MakeAbsolutePath(s, strFile);
