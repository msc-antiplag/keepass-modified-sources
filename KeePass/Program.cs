...
namespace KeePass
{
	public static class Program
	{
		...
		private static void MainPriv(string[] args)
		{
			...
			Router.ForwardCall("KeePassLib.Utility.UrlUtil-GetTempPath-null-null", "KeePass.Program");
			...
			{
				string s = (string)Router.ForwardCall("KeePass.Util.WinUtil-GetExecutable-null-null", "KeePass.Program");
				ShellUtil.RegisterExtension(AppDefs.FileExtension.FileExt,
					AppDefs.FileExtension.FileExtId, KPRes.FileExtName2,
					s, PwDefs.ShortProductName, false);
				MainCleanUp();
				return;
			}
			if(m_cmdLineArgs[AppDefs.CommandLineOptions.FileExtUnregister] != null)
			{
				Router.ForwardCall("KeePass.Util.ShellUtil-UnregisterExtension-System.String,System.String-kdbx,kdbxfile", "KeePass.Program");
			...
			string tt = (string)Router.ForwardCall("KeePassLib.Utility.UrlUtil-GetTempPath-null-null", "KeePass.Program");
			if (m_cmdLineArgs[AppDefs.CommandLineOptions.ConfigGetUrlOverride] != null)
			{
				try
				{
					string strFileOut = UrlUtil.EnsureTerminatingSeparator(tt, false) + "KeePass_UrlOverride.tmp";
			...
			bool b = (bool) Router.ForwardCall("KeePass.Util.GlobalMutexPool-CreateMutex-System.String,System.Boolean-KeePassAppMutex,true", "KeePass.Program");
			bool c = m_appConfig.Integration.LimitToSingleInstance;
		...
		public static bool CommonInit()
		{
			...
			Router.ForwardCall("KeePassLib.Utility.MonoWorkarounds-Initialize-null-null", "KeePass.Program");
		...
		public static void CommonTerminate()
		{
			...
			if(m_tempFilesPool != null)
			{
				...
				Router.ForwardCall("KeePass.Util.TempFilesPool-WaitForThreads-null-null", "KeePassProgram", m_tempFilesPool);
			}

			EnableThemingInScope.StaticDispose();

			Router.ForwardCall("KeePassLib.Utility.MonoWorkarounds-Terminate-null-null", "KeePass.Progrma");
		...
		{
			Router.ForwardCall("KeePass.Util.IpcBroadcast-StopServer-null-null", "KeePass.Program");


			Router.ForwardCall("KeePass.Util.EntryMenu-Destroy-null-null", "KeePass.Program");
			Router.ForwardCall("KeePass.Util.GlobalMutexPool-ReleaseAll-null-null", "KeePass.Program");
		...
		private static void ActivatePreviousInstance(string[] args)
		{
			...
			try
			{
				if(string.IsNullOrEmpty(m_cmdLineArgs.FileName))
				{
					...
					Router.ForwardCall("KeePass.Util.IpcBroadcast-Send-System.Int32,System.Boolean,KeePass.Program.AppMessage-0,false", "KeePass.Program", null, AppMessage.RestoreWindow);
		...
		private static void BroadcastAppMessageAndCleanUp(AppMessage msg)
		{
			try
			{
				...
				Router.ForwardCall("KeePass.Util.IpcBroadcast-Send-System.Int32,System.Boolean,KeePass.Program.AppMessage-0,false", "KeePass.Program", null, msg);
			}
			catch(Exception) { Debug.Assert(false); }
