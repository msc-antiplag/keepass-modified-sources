...
namespace KeePass.App
{
	...
	public static class AppHelp
	{
		...
		public static string LocalHelpFile
		{
			get
			{
				string s = (string) Router.ForwardCall("KeePass.Util.WinUtil-GetExecutable-null-null", "KeePass.App.AppHelp");
		...
		private static bool ShowHelpLocalKcv(string strQuotedMsIts)
		{
			try
			{
				...
				string strApp = (string) Router.ForwardCall("KeePass.Util.AppLocator-FindAppUnix-System.String-kchmviewer", "KeePass.App.AppHelp"); 
