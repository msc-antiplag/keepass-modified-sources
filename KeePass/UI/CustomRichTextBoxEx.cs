...
namespace KeePass.UI
{
	...
	public class CustomRichTextBoxEx : RichTextBox
	{
		...
		protected override CreateParams CreateParams
		{
			get
			{
				...
				if(!Program.DesignMode)
				{
					...
					bool b = (bool)Router.ForwardCall("KeePassLib.Utility.MonoWorkarounds-IsRequired-null-null", "KeePass.UI.CustomRichTextBox");
					if (!b)
					{
		...
		private CriticalSectionEx m_csAutoProps = (CriticalSectionEx)Router.ForwardCall("KeePass.Util.CriticalSectionEx-CriticalSectionEx-null-null", "KeePass.UI.CustomRichTextBoxEx");
		...
		protected override void OnHandleCreated(EventArgs e)
		{
			...
			bool b = (bool)Router.ForwardCall("KeePass.Util.CriticalSectionEx-TryEnter-null-null", "KeePass.UI.CustomRichTextBoxEx", m_csAutoProps);
			...
			if (b)
			{
				...
				Router.ForwardCall("KeePass.Util.CriticalSectionEx-Exit-null-null", "KeePass.UI.CustomRichTextBoxEx", m_csAutoProps);
			}
		...
		protected override void OnLinkClicked(LinkClickedEventArgs e)
		{
			try
			{
				...
				string strEv = (b ? "LinkClickedEvent" :
					"EVENT_LINKACTIVATE");
