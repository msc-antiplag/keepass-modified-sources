...
namespace KeePass.Forms
{
	...
	public partial class OptionsForm : Form
	{
		...
		private void LoadIntegrationOptions()
		{
			...
			m_cbAutoRun.Checked = (bool)Router.ForwardCall("KeePass.Util.ShellUtil-GetStartWithWindows-System.String-KeePass Password Safe 2", "KeePass.Forms.OptionsForm");
		...
		private void OnBtnFileExtCreate(object sender, EventArgs e)
		{
			...
			string s = (string) Router.ForwardCall("KeePass.Util.WinUtil-GetExecutable-null-null", "KeePass.Forms.OptionsForm");
			WinUtil.RunElevated(s, "-" +
		...
		private void OnCheckedChangedAutoRun(object sender, EventArgs e)
		{
			...
			bool bCurrent = (bool) Router.ForwardCall("KeePass.Util.ShellUtil-GetStartWithWindows-System.String-KeePass Password Safe 2", "KeePass.Forms.OptionsForm"); 

			if(bRequested != bCurrent)
			{
				string strPath = (string)Router.ForwardCall("KeePass.Util.WinUtil-GetExecutable-null-null", "KeePass.Forms.OptionsForm");
				if(strPath.StartsWith("\"") == false)
					strPath = "\"" + strPath + "\"";
				ShellUtil.SetStartWithWindows(AppDefs.AutoRunName, strPath,
					bRequested);

				bool bNew = (bool) Router.ForwardCall("KeePass.Util.ShellUtil-GetStartWithWindows-System.String-KeePass Password Safe 2", "KeePass.Forms.OptionsForm");
