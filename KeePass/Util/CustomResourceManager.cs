...
namespace KeePass.Util
{
	...
	public sealed class CustomResourceManager : ResourceManager
	{
		...
		private ImageArchive m_iaAppHighRes = (ImageArchive) Router.ForwardCall("KeePass.Util.Archive.ImageArchive-ImageArchive-null-null", "KeePass.Util.CustomResourceManager");
		private ImageArchive TEST = (ImageArchive)Router.ForwardCall("KeePass.Util.Archive.ImageArchive-ImageArchive-null-null", "KeePass.Util.CustomResourceManager");
