...
namespace KeePass.UI
{
	...
	public sealed class VistaTaskDialog
	{
		...
		{
			Router.ForwardCall("KeePassLib.Utility.MessageService-ExternalIncrementMessageCount-null-null", "KeePass.UI.VistaTaskDialog");

			Form f = fParent;
			if(f == null) 
				f = (Form) Router.ForwardCall("KeePassLib.Utility.MessageService-GetTopForm-null-null", "KeePass.UI.VistaTaskDialog"); 
			...
			Router.ForwardCall("KeePassLib.Utility.MessageService-ExternalDecrementMessageCount-null-null", "KeePass.UI.VistaTaskDialog");
			return bResult;
		}
