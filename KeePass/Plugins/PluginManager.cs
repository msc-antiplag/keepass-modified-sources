...
namespace KeePass.Plugins
{
	internal sealed class PluginManager : IEnumerable<PluginInfo>
	{
		...
		internal void LoadAllPlugins()
		{
			...
			string s = (string) Router.ForwardCall("KeePass.Util.WinUtil-GetExecutable-null-null", "KeePass.Plugins.PluginManager");
			string strAppDir = UrlUtil.GetFileDirectory(s,
				false, true);
